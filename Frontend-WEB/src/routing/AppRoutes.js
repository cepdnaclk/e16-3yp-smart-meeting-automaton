...
import Meetings from "../components/pages/userpages/Meetings";
import Profile from "../components/pages/userpages/Profile";
import Addmeeting from "../components/pages/userpages/Addmeeting";
  ...
  return (
    <section>
      <Switch>
        ...
        {/* ADMIN ROUTES */}
        <AdminRoute path="/addmeeting" exact component={Addmeeting} />
